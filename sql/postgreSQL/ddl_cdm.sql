...
--Create cdm.vocabuary table
CREATE TABLE IF NOT EXISTS cdm.vocabulary ( 
	vocabulary_id VARCHAR(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS cdm.domain (
	domain_id VARCHAR(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS cdm.concept_class (
	concept_class_id VARCHAR(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS cdm.relationship (
	relationship_id VARCHAR(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS cdm.concept_synonym (
	concept_id INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS cdm.source_to_concept_map (
...
CREATE TABLE IF NOT EXISTS cdm.drug_strength (
	...
	box_size INTEGER NULL, valid_start_date DATE NOT NULL,
	valid_end_date DATE NOT NULL, invalid_reason VARCHAR(1) NULL)
;
GO

--Create cdm.cohort_definition table
...
--Create cdm.attribute_definition table
; CREATE TABLE IF NOT EXISTS cdm.attribute_definition (
...
CREATE TABLE IF NOT EXISTS cdm.provider (provider_id INTEGER NOT NULL,
...
--Create cdm.cohort_attribute table
CREATE TABLE IF NOT EXISTS cdm.cohort_attribute (
	cohort_definition_id INTEGER NOT NULL,
	cohort_start_date DATE NOT NULL,
	cohort_end_date DATE NOT NULL,
	subject_id INTEGER NOT NULL,
